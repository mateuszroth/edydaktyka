...
import { Form, Icon, Input, Button, Alert, Checkbox, Row, Spin, Result, notification } from 'antd';
                ...
                <Form.Item label="Grupy zajęciowe:">
                    {getFieldDecorator('groups', {
                        ...
                        <Checkbox.Group style={{ width: '100%' }}>
                            {sortBy(groupsData.groups, ['courseName', 'fieldOfStudy', 'groupNumber', 'groupHalf']).map(
                                group => {
                                    return (
                                        <Row key={group.id}>
