    ...
    return (
      <Form onSubmit={this.handleSubmit} className={styles.root}>
        ...
        <Form.Item label="Tempo powinno być">
          <Select value="jest ok" onChange={() => null}>
            <Option value="zdecydowanie wolniejsze">
        ...
        <Form.Item label="Czy dowiedziałeś się czegoś ważnego?">
          <Select value="zdecydowanie tak" onChange={() => null}>
...
const WrappedNormalLoginForm = Form.create({ name: "questionnaire" })(
  NormalLoginForm
);
