                ...
                <Layout style={{ padding: '0 24px 24px' }}>
                    ...
                    >
                        ...
                        <List
                            ...
                            dataSource={[
                                <div>
                                    <Typography.Title level={4}>Rich Internet Applications</Typography.Title>
                                    <ul>
                                        <li>
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/ria.ppt" target="blank">
                                                Wykład
                                            </a>
                                        </li>
                                    </ul>
                                ...
                                <div>
                                    <Typography.Title level={4}>Zajęcia poświęcone WebGL w HTML5</Typography.Title>
                                    <ul>
                                        <li>
                                            <a
                                ...
                                <div>
                                    <Typography.Title level={4}>Przykłady 3D w HTML5/webGL</Typography.Title>
                                    <ul>
                                        <li>
                                            <a
                                ...
                                <div>
                                    <Typography.Title level={4}>Projekty 3D w HTML5/webGL</Typography.Title>
                                    <ul>
                                        <li>
                                            <a
                                ...
                                <div>
                                    <Typography.Title level={4}>Nie tylko gry w HTML5/webGL</Typography.Title>
                                    <ul>
                                        <li>
                                            <a
                                ...
                                <div>
                                    <Typography.Title level={4}>Literatura zalecana webGL</Typography.Title>
                                    <ul>
                                        <li>
                                            <a
