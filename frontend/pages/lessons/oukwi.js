                ...
                <Layout style={{ padding: '0 24px 24px' }}>
                    ...
                    >
                        ...
                        <List
                            ...
                            dataSource={[
                                <div>
                                    <Typography.Title level={4}>Początki Gospodarki Elektronicznej</Typography.Title>
                                    <ul>
                                        <li>
                                            <a
                                        ...
                                        <li>
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/techpra.htm" target="blank">
                                                Technologiczne prapoczątki Gospodarki Elektronicznej
                                            </a>
                                        </li>
                                        <li>
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/orgpra.htm" target="blank">
                                                Organizacyjne prapoczątki Gospodarki Elektronicznej
                                            </a>
                                        </li>
                                        <li>
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/warunki.htm" target="blank">
                                ...
                                <div>
                                    <Typography.Title level={4}>Bankowość internetowa</Typography.Title>
                                    <ul>
                                        <li>
                                            Część I -{' '}
                                            <a
                                ...
                                <div>
                                    ...
                                    <ul>
                                        <li>
                                            Część I -{' '}
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/si01.pdf" target="blank">
                                                <Icon type="file-pdf" /> PDF{' '}
                                            </a>
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/si01.ppt" target="blank">
                                                <Icon type="file-pdf" /> PPT{' '}
                                            </a>
                                        </li>
                                        <li>
                                            Część II -{' '}
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/si02.pdf" target="blank">
                                                <Icon type="file-pdf" /> PDF{' '}
                                            </a>
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/si02.ppt" target="blank">
                                                <Icon type="file-pdf" /> PPT{' '}
                                            </a>
                                        </li>
                                        <li>
                                            Część III -{' '}
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/si03.pdf" target="blank">
                                                <Icon type="file-pdf" /> PDF{' '}
                                            </a>
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/si03.ppt" target="blank">
                                                <Icon type="file-pdf" /> PPT{' '}
                                            </a>
                                        </li>
                                        <li>
                                            Część IV -{' '}
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/si04.pdf" target="blank">
                                                <Icon type="file-pdf" /> PDF{' '}
                                            </a>
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/si04.ppt" target="blank">
                                                <Icon type="file-pdf" /> PPT{' '}
                                            </a>
                                        </li>
                                        <li>
                                            Część V -{' '}
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/si05.pdf" target="blank">
                                                <Icon type="file-pdf" /> PDF{' '}
                                            </a>
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/si05.ppt" target="blank">
                                                <Icon type="file-pdf" /> PPT{' '}
                                            </a>
                                        </li>
                                        <li>
                                            Część VI -{' '}
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/si06.pdf" target="blank">
                                                <Icon type="file-pdf" /> PDF{' '}
                                            </a>
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/si06.ppt" target="blank">
                                                <Icon type="file-pdf" /> PPT{' '}
                                            </a>
                                        </li>
                                        <li>
                                            Część VII -{' '}
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/si07.pdf" target="blank">
                                                <Icon type="file-pdf" /> PDF{' '}
                                            </a>
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/si07.ppt" target="blank">
                                                <Icon type="file-pdf" /> PPT{' '}
                                            </a>
                                        </li>
                                        <li>
                                ...
                                <div>
                                    <Typography.Title level={4}>Inne i sprzedaż usług przez internet</Typography.Title>
                                    <ul>
                                        <li>
                                        ...
                                        <li>
                                            ...
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/e-uslugi.pdf" target="blank">
                                                <Icon type="file-pdf" /> PDF{' '}
                                            </a>
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/e-uslugi.pdf" target="blank">
                                                <Icon type="file-pdf" /> PPT{' '}
                                ...
                                <div>
                                    ...
                                    <ul>
                                        <li>
                                            <a href="http://www.cs.put.poznan.pl/aurbanski/BitCoin.pdf" target="blank">
                                                Wykład
                                            </a>
                                        </li>
                                    </ul>
