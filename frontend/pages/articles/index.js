        ...
        >
          ...
          <div className={styles.content}>
              ...
              <Col md={12}>
                <List
                  ...
                  dataSource={[
                    ...
                    <a
                      href="http://www.cs.put.poznan.pl/aurbanski/GRY-31.pdf"
                      target="blank"
                    >
                      GRY na urządzeniach elektronicznych
                    </a>,
                    <a
                      href="http://www.cs.put.poznan.pl/aurbanski/teoriagrafow.php"
                      target="blank"
                    >
                      Teoria grafów dla małolatów
                    </a>,
                    <a
                      href="http://www.cs.put.poznan.pl/aurbanski/GRY21.pdf"
                      target="blank"
                    >
                      GRY - trening, rozrywka, ryzyko, nałóg czy grywalizacja
                    </a>,
                    <a
                      href="http://www.cs.put.poznan.pl/aurbanski/GRY.php"
                      target="blank"
                    >
                      GRY - budowa w HTML5
                    </a>
              ...
              <Col md={12}>
                <List
                  ...
                  header={
                    <>
                      <Title level={4}>
                        Sfabularyzowane informatyczne przygody
                      </Title>
            ...
            <Tabs
              type="card"
              animated={true}
              defaultActiveKey={category || "internet"}
            >
              <TabPane tab="Internet" key="internet" id="internet">
                <List
                  ...
                  dataSource={[
                    ...
                    <a
                      href="http://www.eioba.pl/a/339p/raj-3d-w-przegladarce"
                      target="blank"
                    >
              ...
              <TabPane tab="eGospodarka" key="egospodarka" id="egospodarka">
                <List
                  ...
                  dataSource={[
                    <a
                      href="http://www.eioba.pl/a/2zyu/nie-zastrzelisz-kelnera"
                      target="blank"
                    >
                    ...
                    <a
                      ...
                      target="blank"
                    >
                      Schemat działania programu partnerskiego sklepu
                      internetowego
                    </a>,
                    <a
                    ...
                    <a
                      href="http://www.eioba.pl/a/1vig/daj-sekunde-potrzebujacemu"
                      target="blank"
                    >
                    ...
                    <a
                      href="http://www.eioba.pl/a/30hj/zbudowalem-dom-na-chmurze"
                      target="blank"
                    >
              ...
              <TabPane tab="Informatyka" key="informatyka">
                <List
                  ...
                  dataSource={[
                    ...
                    <a
                      href="http://andrzeju.pl/stara.php?s=geny"
                      target="blank"
                    >
                      Geny z komputera
                    </a>,
                    ...
                    <a
                      ...
                      target="blank"
                    >
                      Jak maszyna Turinga dowiodła, że komputer nie wszystko
                      może
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/2wlp/historia-tamagotchi"
                      target="blank"
                    >
                      Historia tamagotchi
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/3jzk/mikrokomputerowa-iskra"
                      target="blank"
                    >
                    ...
                    <a
                      href="http://andrzeju.pl/stara.php?s=train"
                      target="blank"
                    >
                      Edukacyjny system programowania "TRAIN"
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/4d5c/tworczosc-programistyczna"
                      target="blank"
                    >
              ...
              <TabPane tab="Kosmos" key="kosmos">
                <List
                  ...
                  dataSource={[
                    <a
                      href="http://www.eioba.pl/a/2uz5/biedacy-na-marsa"
                      target="blank"
                    >
                      Biedacy na Marsa
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/3363/raj-na-sztucznej-planecie"
                      target="blank"
                    >
                      Raj na sztucznej planecie
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/2vtm/urodzona-w-2010-na-ksiezycu"
                      target="blank"
                    >
                    ...
                    <a
                      href="http://www.eioba.pl/a/3345/sztuczna-planeta"
                      target="blank"
                    >
                      Sztuczna planeta
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/2woc/winda-do-nieba"
                      target="blank"
                    >
                      Windą do nieba
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/3onh/pieciolatek-na-ksiezycu"
                      target="blank"
                    >
                      Pięciolatek na Księżycu
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/4ibi/ped-do-nieba"
                      target="blank"
                    >
                      Pęd do Nieba
                    </a>
                ...
                <List
                  ...
                  dataSource={[
                    ...
                    <a
                      ...
                      target="blank"
                    >
                      Jak zmienić stuletnie przyzwyczajenie do niewygody i
                      szkodliwości
                    </a>,
                    <a
                    ...
                    <a
                      ...
                      target="blank"
                    >
                      Elektryczne auto. Czy Tesla Motors uczyni je praktycznym i
                      powszechnym?
                    </a>,
                    <a
                    ...
                    <a
                      href="http://www.eioba.pl/a/4an0/samochod-na-darmowa-energie"
                      target="blank"
                    >
                      Samochód na darmową energię
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/4cpo/hyperloop-czesc-2"
                      target="blank"
                    >
                      Hyperloop cz.2
                    </a>
              ...
              <TabPane tab="Książki" key="ksiazki">
                <List
                  ...
                  dataSource={[
                    <a
                      href="http://www.eioba.pl/a/3tgf/moje-science-fiction"
                      target="blank"
                    >
                    ...
                    <a
                      href="http://www.eioba.pl/a/3nbi/epapier-dla-ucznia"
                      target="blank"
                    >
                      e-papier dla ucznia
                    </a>,
                    ...
                    <a
                      ...
                      target="blank"
                    >
                      Biblioteki publiczne okradają autorów, ale e-booki ukradną
                      biblioteki
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/3j43/opowiadam-wiec-jestem"
                      target="blank"
                    >
              ...
              <TabPane tab="Opowiadania" key="opowiadania">
                <List
                  ...
                  dataSource={[
                    ...
                    <a
                      href="http://www.cs.put.poznan.pl/aurbanski/komputer.php"
                      target="blank"
                    >
                      Wierszyk "Komputer"(elementarz szkolny)
                    </a>,
                    <a
                      href="http://www.cs.put.poznan.pl/aurbanski/tata.php"
                      target="blank"
                    >
                      Opowiadanie "Mój tata jest programistą"(elementarz
                      szkolny)
                    </a>,
                    <a
                      href="http://andrzeju.pl/stara.php?s=przyprog"
                      target="blank"
                    >
                      Przygody programistów
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/1v3o/zycie-dla-zycia"
                      target="blank"
                    >
                      Życie dla życia
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/28ky/imaginacja-lennona"
                      target="blank"
                    >
                      Imaginacja Lenona
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/3xxf/silicon-island"
                      target="blank"
                    >
                      Silicon Island
                    </a>,
                    <a
                      href="http://andrzeju.pl/opowiadania.php?idm=122&idt=122"
                      target="blank"
                    >
                      REFLEX
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/2wte/jas-i-malgosia-na-odwyrtke"
                      target="blank"
                    >
                      Jaś i Małgosia ... na odwyrtkę
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/47a1/matematyczna-przyjazn"
                      target="blank"
                    >
                    ...
                    <a
                      href="http://andrzeju.pl/stara.php?s=bajka"
                      target="blank"
                    >
                      Bajeczka o komputerach
                    </a>,
                    <a
                      href="http://andrzeju.pl/opowiadania.php?idm=123&idt=123"
                      target="blank"
                    >
                      Powrót z delegacji
                    </a>,
                    <a
                      href="http://mimuw.edu.pl/delta/artykuly/delta0308/kwota.pdf"
                      target="blank"
                    >
                      Słowna kwota("DELTA")
                    </a>,
                    ...
                    <a
                      href="http://www.eioba.pl/a/36dk/problem-cioci-ogrodniczki"
                      target="blank"
                    >
                      Problem cioci ogrodniczki
                    </a>,
                    <a
                      href="http://www.cs.put.poznan.pl/aurbanski/dp.php"
                      target="blank"
                    >
                      Opowiadanie i wierszyk (pisemko "Domowe przedszkole")
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/1v0x/jego-wirtualny-swiat"
                      target="blank"
                    >
                      Jego wirtualny świat
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/1ubs/zmysl-sieci"
                      target="blank"
                    >
                      Zmysł sieci
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/3rp3/udanedziecko-pl"
                      target="blank"
                    >
                      UdaneDziecko.pl
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/2wlc/wzieli-jasia-do-szpitala"
                      target="blank"
                    >
                      Wzięli Jasia do szpitala
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/2wre/ksiaze-z-bajki-dla-ksiecia"
                      target="blank"
                    >
                      Książę z bajki dla... księcia
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/442g/tajemniczy-upadek"
                      target="blank"
                    >
                      Tajemniczy upadek
                    </a>,
                    ...
                    <a
                      href="http://andrzeju.pl/opowiadania.php?idm=104&idt=104"
                      target="blank"
                    >
                      Zmysł sieci
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/4cwr/wlasna-stereofonia"
                      target="blank"
                    >
                      Własna stereofonia
                    </a>
              ...
              <TabPane tab="Inne" key="inne">
                <List
                  ...
                  dataSource={[
                    <a
                      href="http://www.eioba.pl/a/2wpr/klonowanie-stereo"
                      target="blank"
                    >
                      Klonowanie stereo
                    </a>,
                    ...
                    <a
                      href="http://www.eioba.pl/a/3mld/szok-przyszlosci"
                      target="blank"
                    >
                      Szok przyszłości
                    </a>,
                    ...
                    <a
                      href="http://www.eioba.pl/a/32g3/sala-samobojcow"
                      target="blank"
                    >
                      Sala samobójcow
                    </a>,
                    ...
                    <a
                      ...
                      target="blank"
                    >
                      Przepłynąć z oceanu czerwonego na niebieski czyli sztuka
                      innowacji
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/3lh3/archipelag-saharyjski"
                      target="blank"
                    >
                      Archipelag sacharyjski
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/32qm/nieekologiczne-elektrownie"
                      target="blank"
                    >
                      Nieekologiczne elektrownie
                    </a>,
                    <a
                      href="http://www.eioba.pl/a/2vuj/alko-holowanie"
                      target="blank"
                    >
                      Alko-holowanie
                    </a>,
