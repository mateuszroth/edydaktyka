          ...
          >
            ...
            <div className={styles.content}>
              <div>
                <ul>
                  <li>
                    <a href="http://www.cs.put.poznan.pl/aurbanski/Optymalny-zakup-na-odleglosc.pdf">
                      Optymalny zakup na odległość
                    </a>
                  </li>
                  <li>
                    <a href="http://www.cs.put.poznan.pl/aurbanski/GRY-31.pdf">
                      GRY na urządzeniach elektronicznych
                    </a>
                  </li>
                  <li>
                    <a href="http://www.cs.put.poznan.pl/aurbanski/GRY21.pdf">
