...
import { Avatar, Button, Layout, notification, Spin, Icon, Typography, Row, Col, Upload } from 'antd';
                        ...
                        <div className={styles.content}>
                            ...
                            <Row>
                                <Col span={24}>
                                    ...
                                    <ChangeGroup />
                                    <Button type="primary" onClick={() => Router.push('/group-register')} size="large">
                                        Dopisz się do grupy
                                    </Button>
                                </Col>
                            </Row>
