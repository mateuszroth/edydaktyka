            ...
            <div>
              ...
              <ol>
                <li>
                  ...
                  części serwisu(lewe menu). Dla podjęcia ściślejszej wspópracy
                  trzeba jednak zarejestrować się w odpowiednich
                  grupach(niekiedy jest ich wiecej nawet jeśli nie wiąże się to
                ...
                <li>
                  ...
                  Można też podać dodatkową grupę przy ponownej rejestracji
                  pamiętając o uzyciu dokładnie tego samego hasła i poprawnych
                  innych danych.
                </li>
                <a name="sprawozdania" />
                <li>
                  <a name="sprawozdania">
                    <b>Jak przesłać sprawozdanie?</b>
                  </a>
                  <br />
                  Aby to zrobić należy być zalogowanym i skorzystać z pozycji
                  "Sprawozdania" w poziomym menu. Aby móc się logować należy się
