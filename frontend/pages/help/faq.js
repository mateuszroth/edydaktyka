                    ...
                    >
                        <div>
                            ...
                            <ol style={{ maxWidth: 900 }}>
                                <li>
                                    <b>Od czego zacząć pracę z serwisem jako student lub dyplomant?</b>
                                    <br />W wielu przypadkach wystarczy przeglądanie informacyjnej części serwisu (górne
                                    menu). Dla podjęcia ściślejszej wspópracy trzeba jednak{' '}
                                    <Link href="/group-register">
                                        <a>zarejestrować się w odpowiednich grupach</a>
                                    </Link>{' '}
                                    (niekiedy jest ich wiecej nawet jeśli nie wiąże się to z dodatkowymi ocenami
                                    końcowymi).
                                </li>
                                <li>
                                    ...
                                    w głównym menu. Aby móc się logować należy się wcześniej zarejestrować.
                                </li>
                            </ol>
                        </div>
                    </Layout.Content>
