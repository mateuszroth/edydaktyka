...
import { Layout, Breadcrumb, Divider, Typography, Row, Col, Button, Modal, Table } from 'antd';
...
const showRoomPath = () => {
    Modal.info({
        ...
        content: (
            <div>
                <img src="http://www.cs.put.poznan.pl/aurbanski/praca.jpg" alt="Pokój konsultacji" width="250" />
                <br />
                <img src="http://www.cs.put.poznan.pl/aurbanski/Plan-CW5.png" alt="Dojście" width="400" />
            </div>
        ),
        onOk() {},
    });
                        ...
                        <div>
                            <div>
                                ...
                                <Row>
                                    <Col sm={18}>
                                        <Typography.Paragraph>
                                            <strong>osobiste</strong> - w środy od 15:00 do 16:40 w pokoju 105 w Centrum
                                            Wykładowym PP
                                        </Typography.Paragraph>
                                        <Typography.Paragraph>
                                    ...
                                    <Col sm={6} style={{ textAlign: 'center' }}>
                                        <Button onClick={showRoomPath}>Zobacz dojście do pokoju</Button>
                                    </Col>
                                </Row>
                                <Row>
                                    <Consultations />
